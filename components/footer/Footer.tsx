        ...
        <div className={styles.footer}>
            <div className="container">
                <footer>
                    ...
                    <div className={styles.footer_contacts__mobile}>
                        <Logo />
                        <ul>
                            <li className={styles.contacts_item}>
                                <p className={styles.contacts_text}>We accept your orders:</p>
                    ...
                    <div className={styles.footer_nav__mobile}>
                        <div className={styles.footer_nav__mobile_links}>
                            <ul className={styles.footer_list}>
                                <li className={styles.footer_item}>
                                    <Link href="/categories/pizza" className={styles.footer_link}>
                                        Pizza
                        ...
                        <span className={styles.contacts_item}>
                            <p className={styles.contacts_text}>
                                &copy; {new Date().getFullYear()} FreshHub
                            </p>
                        </span>
