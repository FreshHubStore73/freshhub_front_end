...
import { useObserveUserData } from '@/hooks/useObserveUserData';

// eslint-disable-next-line react/display-name
const UserBtn = forwardRef<HTMLElement>((props, ref) => {
    const user = useAuthStore((state) => state.profile);

    const { loading, /*error*/ } = useObserveUserData();
    ...
    const menuContent = user.email || user.phoneNumber ? (
        [
            <MenuItem
                key="profile"
                onClick={() => {
